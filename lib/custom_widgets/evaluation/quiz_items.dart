...
import 'package:learn_with_ar_v1/custom_widgets/evaluation/result_items.dart';
...
class QuizItems extends StatefulWidget {
  ...
  const QuizItems({Key? key, required this.subject}) : super(key: key);
    ...
    void check(var opt) {
      if (index == maxIndex) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => QuizResult(score, widget.subject),
          ),
        );
        // Get.to(
