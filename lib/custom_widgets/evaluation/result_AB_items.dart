...
class QuizResultAB extends StatefulWidget {
  var score;
  final List<Map<dynamic, dynamic>> subject;

  QuizResultAB(this.score, this.subject, {super.key});

  @override
  State<QuizResultAB> createState() => _QuizResultABState();
}

class _QuizResultABState extends State<QuizResultAB> {
  final maxIndex = 9;
                          ...
                          child: IconButton(
                              onPressed: () {
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        QuizABItems(subject: widget.subject),
                                  ),
                                );
                                // Get.to(
