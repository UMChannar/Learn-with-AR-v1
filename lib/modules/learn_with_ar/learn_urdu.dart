...
class LearnUrdu extends StatefulWidget {
  static const routeName = '/learn-urdu';
  const LearnUrdu({super.key});

  @override
  State<LearnUrdu> createState() => _LearnUrduState();
}

class _LearnUrduState extends State<LearnUrdu> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset(
      'assets/audio/urdu/video/urdu.mp4',
    )..initialize().then(
        (_) => setState(() {}),
      );
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Text(
                                "السلام عليكم ${_usernameProvider.username}",
                          ...
                          Text(
                            "کیا آپ اردو سیکھنے کے لیے تیار ہیں؟",
                            style: Theme.of(context)
                                .textTheme
                                .titleMedium!
                                .copyWith(
