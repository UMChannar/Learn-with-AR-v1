...
class LearnBirds extends StatefulWidget {
  static const routeName = '/learn-birds';
  const LearnBirds({super.key});

  @override
  State<LearnBirds> createState() => _LearnBirdsState();
}

class _LearnBirdsState extends State<LearnBirds> {
  @override
