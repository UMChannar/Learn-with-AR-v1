...
class LearnEnglish extends StatefulWidget {
  static const routeName = '/learn-english';
  const LearnEnglish({super.key});

  @override
  State<LearnEnglish> createState() => _LearnEnglishState();
}
...
class _LearnEnglishState extends State<LearnEnglish> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset(
      'assets/audio/english/video/english.mp4',
    )..initialize().then(
        (_) => setState(() {}),
      );
  }
